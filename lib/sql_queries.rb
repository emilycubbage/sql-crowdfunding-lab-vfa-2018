...
"SELECT projects.title, pledges.amount - projects.funding_goal FROM pledges INNER JOIN projects ON  pledges.project_id = projects.id WHERE (pledges.amount - projects.funding_goal) >= -10 GROUP BY pledges.project_id;"
end
